...
// Import helmet to set security-related HTTP response headers (XSS protection, content sniffing, etc.)
import helmet from 'helmet';

// Import morgan for HTTP request logging — useful for debugging and monitoring
...
// helmet: sets various security HTTP headers to protect against common web vulnerabilities
app.use(helmet());

// morgan: logs each incoming HTTP request (method, URL, status, response time) — 'dev' format for readability
app.use(morgan('dev'));
